...
const SUPABASE_SCHEMA_MIGRATION_MESSAGE =
  "Supabase schema is out of date. Run supabase/migrations/20260430_canvas_image_layers.sql and any earlier pending migrations in your Supabase project, then refresh.";
