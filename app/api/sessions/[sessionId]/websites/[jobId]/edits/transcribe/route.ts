...
export async function POST(
  ...
  const fileName = audioFile.name || `website-edit-voice.${extensionFromMimeType(mimeType)}`;
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to transcribe the voice request.";
